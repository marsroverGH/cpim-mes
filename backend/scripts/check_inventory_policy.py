...
checks={
 ...
 'migration manager tests expect 36': allin(manager_test,'len(migs) != 36','expected 36 migrations'),
 'migration guard expects 36 ordered migrations': allin(manager_guard,"'36 ordered SQL migrations exist'",'len(files) == 36'),
