...
checks = {
    ...
    'migration manager tests expect 35': 'len(migs) != 35' in manager_test and 'expected 35 migrations' in manager_test,
    'migration guard expects 35 ordered migrations': "'35 ordered SQL migrations exist'" in manager_guard and 'len(files) == 35' in manager_guard,
