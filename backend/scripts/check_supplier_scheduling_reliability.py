...
checks = {
    ...
    'migration manager includes 0035 under current migration set': '{35,' in manager and 'len(migs) != 38' in manager_test,
    'migration guard advances beyond 0035 without losing it': "'38 ordered SQL migrations exist'" in manager_guard and 'len(files) == 38' in manager_guard,
