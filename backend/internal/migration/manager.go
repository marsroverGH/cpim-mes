...
var legacyChecks = []legacyCheck{
	...
	{41, `SELECT to_regclass('public.recovery_scenarios') IS NOT NULL AND to_regclass('public.recovery_scenario_actions') IS NOT NULL AND to_regclass('public.recovery_scenario_runs') IS NOT NULL AND to_regclass('public.recovery_scenario_case_results') IS NOT NULL AND to_regclass('public.recovery_scenario_summaries') IS NOT NULL AND to_regclass('public.recovery_scenario_publications') IS NOT NULL AND to_regclass('public.v_recovery_scenario_comparison') IS NOT NULL`},
}
